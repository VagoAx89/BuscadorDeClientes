...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Acr.UserDialogs.ActivityLifecycleCallbacks, Acr.UserDialogs", ActivityLifecycleCallbacks.class, __md_methods);
	}
	...
	public ActivityLifecycleCallbacks ()
	{
		...
		if (getClass () == ActivityLifecycleCallbacks.class) {
			mono.android.TypeManager.Activate ("Acr.UserDialogs.ActivityLifecycleCallbacks, Acr.UserDialogs", "", this, new java.lang.Object[] {  });
		}
	}
